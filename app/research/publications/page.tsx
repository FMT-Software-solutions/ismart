...
const publications = [
  // Sexuality Research Publications
  {
    ...
    category: 'sexuality',
    abstract:
      'This study examines the current state of sexuality education in Ghanaian schools, identifying key challenges and opportunities for improvement. Through interviews with educators, students, and parents, the research highlights cultural barriers, resource limitations, and policy gaps that affect the delivery of holistic sexuality education.',
  },
  {
  ...
  },
  {
    ...
    category: 'sexuality',
    abstract:
      'This study explores how cultural factors shape sexual attitudes and behaviors in Ghana, examining the influence of traditional values, religious beliefs, and changing social norms. The research highlights the complex interplay between cultural heritage and contemporary influences in shaping sexuality.',
  },
  ...
  },
  {
    ...
    category: 'marriage',
    abstract:
      'This study examines how digital technology influences communication patterns and relationship quality in marriages. Findings suggest that technology can both enhance and hinder marital communication, depending on how couples integrate digital tools into their relationship.',
  },
  {
    ...
    category: 'marriage',
    abstract:
      'This research evaluates premarital counseling practices in Ghana and their impact on relationship outcomes. The study examines different approaches to premarital preparation, including religious, cultural, and secular programs, and assesses their effectiveness in preparing couples for marriage.',
  },
  {
    ...
    category: 'marriage',
    abstract:
      'This study investigates how cultural factors influence partner choice and mate selection processes in contemporary Ghana. The research examines the evolving balance between traditional practices and modern approaches to finding a spouse, highlighting generational differences and urban-rural variations.',
  },
  ...
  // Family Research Publications
  {
    ...
    category: 'family',
    abstract:
      'This longitudinal study examines the relationship between parenting practices and child development outcomes in urban Ghanaian families. The research identifies specific parenting behaviors that promote positive developmental trajectories in cognitive, social, and emotional domains.',
  },
  {
    ...
    category: 'family',
    abstract:
      "This study investigates how digital technology influences parenting practices and family dynamics in contemporary Ghanaian families. The research highlights challenges parents face in managing children's screen time, monitoring online activities, and modeling healthy technology use.",
  },
  {
    ...
    category: 'family',
    abstract:
      'This qualitative study examines how families cope with and adapt to economic challenges in Ghana. Through in-depth interviews with families experiencing financial hardship, the research identifies key resilience factors that help families maintain functioning and well-being despite adversity.',
  },
  {
    ...
    category: 'family',
    abstract:
      'This study explores how cultural factors shape parenting approaches in Ghana, examining the influence of traditional values, religious beliefs, and changing social norms. The research highlights the complex interplay between cultural heritage and contemporary influences in shaping parenting practices.',
  },
];
        ...
        <div className="hero-gradient text-white">
          <div className="container-custom py-20">
            ...
            >
              ...
              >
                Explore our published research on sexuality, marriage, and
                family life.
              </motion.p>
            </motion.div>
          </div>
            ...
            >
              <div>
                ...
                <p className="text-muted-foreground">
                  Sharing our research findings with the academic community and
                  the public
                </p>
              </div>
          ...
          >
              ...
              <Card className="h-full">
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-6">
                    Our sexuality research explores human sexuality through
                    biological, psychological, social, and cultural lenses.
                  </p>
                </CardContent>
                <CardFooter>
            ...
            >
              <Card className="h-full">
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-6">
                    Our relationship research investigates dynamics, patterns,
                    and factors that contribute to relationship success.
                  </p>
                </CardContent>
                <CardFooter>
                  <Button variant="outline" asChild>
            ...
            >
              <Card className="h-full">
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-6">
                    Our family research studies dynamics, parenting practices,
                    and their impact on child development and family well-being.
                  </p>
                </CardContent>
                <CardFooter>
                  <Button variant="outline" asChild>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <motion.p variants={fadeIn} className="paragraph mb-8">
              Your contribution helps us continue our vital research and share
              our findings with the world.
            </motion.p>
            <motion.div
              variants={fadeIn}
