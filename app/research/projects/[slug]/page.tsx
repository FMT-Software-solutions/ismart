...
const projects = [
  ...
  },
  {
    ...
    description:
      'A study examining barriers and facilitators to sexual health services and their impact on sexual health outcomes in diverse communities.',
    ...
    methodology:
      'This study combines surveys, medical record reviews, and interviews with service users and providers to examine patterns of sexual health service utilization and associated outcomes.',
    findings:
      'Preliminary data indicates significant disparities in access to sexual health services, with young people, rural residents, and those with lower socioeconomic status facing particular barriers.',
    publications: [],
  },
  {
  ...
  },
  {
    ...
    methodology:
      'This study combines surveys, communication diaries, and observation of couple interactions to examine how technology influences marital communication.',
    findings:
      'Preliminary data suggests that technology can both facilitate and impede marital communication, with effects depending on how couples integrate digital tools into their relationship.',
    publications: [],
  },
  {
    ...
    methodology:
      'This longitudinal study follows couples from premarital counseling through the first two years of marriage, comparing outcomes across different counseling approaches.',
    findings:
      'The study is currently in the recruitment phase, with no findings to report yet.',
    publications: [],
  },
  {
    ...
    methodology:
      'This longitudinal study follows families with children aged 0-5 over a three-year period, using observations, interviews, and developmental assessments to track parenting practices and child outcomes.',
    findings:
      'The study is currently in the recruitment phase, with no findings to report yet.',
    publications: [],
  },
        ...
        <div className="container-custom">
          ...
          >
            <motion.div variants={fadeIn}>
              ...
              <p className="paragraph mb-6">{project.description}</p>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    {project.findings || 'No findings to report yet.'}
                  </p>
                </CardContent>
              </Card>
            </motion.div>
                  ...
                  <Card className="overflow-hidden h-full">
                    ...
                    <CardFooter>
                      <Button variant="outline" asChild>
                        <Link
                          href={`/research/projects/${relatedProject.slug}`}
                        >
        ...
        <div className="container-custom">
          ...
          >
            ...
            <motion.p variants={fadeIn} className="paragraph mb-8">
              ...
              {project.category}, generating knowledge that can inform policy,
